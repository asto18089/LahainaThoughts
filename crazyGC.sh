...
# The number of moved block will be displayed per iteration of the loop. 
# When the number becomes steady (i.e. stable or increasing sigificantly slower), the GC is completed.
while true
do
    a=0
    while [ $a -lt 100 ]
